...
|xref:tse-fundamentals-lesson-02.adoc[Lesson 2 - Setting up for the course]| This lesson is all about getting set up and ready to code. You'll download the code and review the resources and tools that will be used.
...
|xref:tse-fundamentals-step-by-step-lesson-06.adoc[Lesson 6 - Embed Natural Language Search]| In this lesson we'll add code to embed natural language search.
