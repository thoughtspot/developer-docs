...
<a class="tutorial-pagination__btn tutorial-pagination__prev" href="{{navprefix}}/tutorials/tse-fundamentals/lesson-06">&larr; Previous</a>
<a class="tutorial-pagination__btn tutorial-pagination__next" href="{{navprefix}}/tutorials/tse-fundamentals/lesson-08">Next &rarr;</a>
</div>
++++
