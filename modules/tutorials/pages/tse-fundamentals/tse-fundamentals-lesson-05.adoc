...
image::images/tutorials/tse-fundamentals/lesson-05-search-console.png[Console output, scale=50%]
...
image::images/tutorials/tse-fundamentals/lesson-05-data-source-added.png[data source added, scale=50%]
