...
This div tells the TSE SDK where to render content.
...
You can use any web server, but in this course, we'll use the Live Server extension described in xref:tse-fundamentals-lesson-02.adoc.

You can start Live Server by clicking the image::images/tutorials/tse-fundamentals/lesson-04-start-live-server.png[start live server] button.
Once it starts, the button will change to image::images/tutorials/tse-fundamentals/lesson-04-live-server-running.png[live server running].
