...
<a class="tutorial-pagination__btn tutorial-pagination__prev" href="{{navprefix}}/tutorials/tse-fundamentals/lesson-03">&larr; Previous</a>
<a class="tutorial-pagination__btn tutorial-pagination__next" href="{{navprefix}}/tutorials/tse-fundamentals/lesson-05">Next &rarr;</a>
</div>
++++
