...
image:images/tutorials/tse-fundamentals/lesson-04-source-files.png[Project files,width=540,height=120px]
...
image:images/tutorials/tse-fundamentals/lesson-04-start-live-server.png[start live server, width=200px, height=50]

Once it starts, the button will change to live server running

image:images/tutorials/tse-fundamentals/lesson-04-live-server-running.png[live server running, width=200, height=50].
