...
image::images/tutorials/tse-fundamentals/lesson-01-tse-options.png[Embedding options with TSE]
...
* Analysts create analytics, developers create software - with ThoughtSpot Embedded there's no long requirements cycle for dashboards where an analyst defines the requirements, developers code, and the review cycle begins. Analysts create content and developers simply embed.
