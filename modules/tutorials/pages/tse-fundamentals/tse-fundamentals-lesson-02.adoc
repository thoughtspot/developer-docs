...
:page-pageid: lesson-02-setting-up-for-the-course
...
image::images/doc-links.png[Access the guides from ThoughtSpot]
...
image::images/playground-sage-search.png[Using the playground to generate code]
...
image::images/download-git.png[Download from GitHub]
...
xref:./tse-fundamentals-lesson-01.adoc[< prev] | link:../lesson-03-security-setup/README-03.adoc[next >]
