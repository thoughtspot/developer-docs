...
* On this site: link:https://developers.thoughtspot.com/docs[https://developers.thoughtspot.com/docs, window=_blank]
...
The following figure shows the Playground page for embedding Natural Language Conversation.

[.widthAuto]
[.bordered]
image:images/tutorials/tse-fundamentals/lesson-02-playground-spotter-search.png[Using the playground to generate code, scale=50%]
