...
image::images/tutorials/tse-fundamentals/lesson-08new-viz-link.png[Nav bar liveboard visualization links]
...
image::images/tutorials/tse-fundamentals/lesson-08visualization-console.png[Console output]
...
image::images/tutorials/tse-fundamentals/lesson-08empty-visualization.png[Empty liveboard page]
...
image::images/tutorials/tse-fundamentals/lesson-08liveboard-viz-selected.png[Liveboard selected in the playground]
...
image::images/tutorials/tse-fundamentals/lesson-08visualization-embed-results.png[Liveboard embed results]
