...
See the link:https://thoughtspot.github.io/cs_tools/[list of tools, window=_blank] for the current capabilities.
...
<a class="tutorial-pagination__btn tutorial-pagination__prev" href="{{navprefix}}/tutorials/tse-fundamentals/lesson-10">&larr; Previous</a>
