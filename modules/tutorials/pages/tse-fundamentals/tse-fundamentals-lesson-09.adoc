...
image::images/tutorials/tse-fundamentals/lesson-09new-app-link.png[Nav bar with application link]
...
image::images/tutorials/tse-fundamentals/lesson-09app-console.png[Console output]
...
image::images/tutorials/tse-fundamentals/lesson-09default-app-playground.png[Default application page]
...
image::images/tutorials/tse-fundamentals/lesson-09embedded-application.png[Embedded application]
