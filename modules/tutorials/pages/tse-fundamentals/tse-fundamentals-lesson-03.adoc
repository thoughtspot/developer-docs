...
image::images/tutorial/tse-fundamentals/lesson-03-security-settings.png[Security Settings page in ThoughtSpot UI]
...
image::images/tutorial/tse-fundamentals/lesson-03-saml-configuration.png[SAML configuration dialog, width=330, height=375]
...
image::images/tutorial/tse-fundamentals/lesson-03-saml-trusted-auth-config.png[SAML redirect configuration, width=660, height=170]
