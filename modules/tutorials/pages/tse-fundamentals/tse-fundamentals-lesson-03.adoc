...
<a class="tutorial-pagination__btn tutorial-pagination__prev" href="{{navprefix}}/tutorials/tse-fundamentals/lesson-02">&larr; Previous</a>
<a class="tutorial-pagination__btn tutorial-pagination__next" href="{{navprefix}}/tutorials/tse-fundamentals/lesson-04">Next &rarr;</a>
</div>
++++
