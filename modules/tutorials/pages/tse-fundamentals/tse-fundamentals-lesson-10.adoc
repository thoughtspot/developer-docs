...
See the link:https://developers.thoughtspot.com/docs/customize-style[Style customization, window=_blank] for more details about each setting.

== Using the customizations setting

The Visual Embed SDK allows you to set a custom style sheet or custom variables (or a combination of both). Full details can be found in the link:https://developers.thoughtspot.com/docs/custom-css[Developer Documentation, window=_blank].
