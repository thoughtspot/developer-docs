...
image::images/tutorials/tse-fundamentals/lesson-10style-page.png[Custom style page]
...
image::images/tutorials/tse-fundamentals/lesson-10search-dark-theme.png[example of search with dark theme]
