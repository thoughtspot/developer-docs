...
The Playground is organized into topics, which compose the expandable areas of the lefthand side menu: image:images/tutorials/rest-api/playground-leftside-menu.png[Playground Left Side Menu, float=left, width=225]
