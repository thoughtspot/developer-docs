...
image::images/tutorials/rest-api/json-request-format.png[JSON request format in Playground, role=half-width]
...
image::images/tutorials/rest-api/403-response.png[403 Forbidden Access Response, role=half-width]

=== JSON response format
If there is a `200` success, the model of the response is available as a link:

image::images/tutorials/rest-api/200-response.png[200 Good Response, role=half-width]
