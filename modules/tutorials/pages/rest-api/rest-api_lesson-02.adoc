= 02: Simple Python V2.0 REST API Implementation 
...
All of those methods will return a Response object, which you assign to a variable to do further processing:
...
== 03 - Authenticating into ThoughtSpot REST API
