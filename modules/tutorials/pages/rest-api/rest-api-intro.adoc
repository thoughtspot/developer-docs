...
* link:https://github.com/thoughtspot/thoughtspot_rest_api_python[The `thoughtspot_rest_api` GitHub repo, window=_blank] library (capable of REST API V1 and V2.0) in your local Python environment
