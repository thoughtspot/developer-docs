...
ThoughtSpot instances are locked down by default, rejecting API requests from web servers that have not been added to the CORS whitelist.
...
xref:rest-api_lesson-05.adoc[Next: 05 - TypeScript SDK > ]
