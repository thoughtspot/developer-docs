...
The example app also uses link:https://flowbite-react.com/[Flowbite, window=_blank] for pre-defined UI components and link:https://tailwindcss.com/docs/installation/framework-guides/nextjs[Tailwind CSS, window=_blank] as a unified styling system.
...
<a class="tutorial-pagination__btn tutorial-pagination__next" href="{{navprefix}}/tutorials/react-components/lesson-01">Next &rarr;</a>
</div>
++++
