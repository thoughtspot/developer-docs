...
:linkattrs:
:sectanchors:
:page-title: Wire in a custom action
:page-pageid: embed-data-driven-app__wire-custom-action
...
Your team does not want to only look at the data.
...
<a class="tutorial-pagination__btn tutorial-pagination__prev" href="{{navprefix}}/tutorials/embed-data-driven-app/style-to-match-portal">&larr; Previous</a>
