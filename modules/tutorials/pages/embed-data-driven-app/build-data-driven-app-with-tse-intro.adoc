...
This guide covers the build end to end, the same path you would take for your own app. It matches the link:https://github.com/nrentz-ts/spottercode[SpotStay app on GitHub] if you want to work through it in code.
...
<a class="tutorial-pagination__btn tutorial-pagination__next" href="{{navprefix}}/tutorials/embed-data-driven-app/into-developer-portal">Next &rarr;</a>
</div>
++++
