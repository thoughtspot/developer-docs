...
* Embed Spotter so managers can ask follow-up questions in plain language — "why did occupancy drop for our Austin listings this week?" — without you building a custom query interface for every possible question.
