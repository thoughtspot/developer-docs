...
:linkattrs:
:sectanchors:
:page-title: Get the base Liveboard rendering
:page-pageid: embed-data-driven-app__base-liveboard-rendering
...
<a class="tutorial-pagination__btn tutorial-pagination__prev" href="{{navprefix}}/tutorials/embed-data-driven-app/into-developer-portal">&larr; Previous</a>
<a class="tutorial-pagination__btn tutorial-pagination__next" href="{{navprefix}}/tutorials/embed-data-driven-app/make-it-conversational">Next &rarr;</a>
</div>
++++
