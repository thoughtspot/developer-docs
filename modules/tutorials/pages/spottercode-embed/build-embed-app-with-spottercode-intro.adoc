...
:linkattrs:
:sectanchors:
:page-title: Embedding ThoughtSpot with SpotterCode
...
You’re a full-stack developer at SpotStay, a short-term rental platform.
...
Here is the link:https://github.com/nrentz-ts/spottercode[SpotStay app on GitHub] so you can follow along as we code.
...
. xref:build-embed-app-with-spottercode-step-01.adoc[Set up SpotterCode]
. xref:build-embed-app-with-spottercode-step-02.adoc[Embed the Liveboard view]
. xref:build-embed-app-with-spottercode-step-03.adoc[Embed Spotter]
. xref:build-embed-app-with-spottercode-step-04.adoc[Troubleshooting]
. xref:build-embed-app-with-spottercode-summary.adoc[Summary]
...
<a class="tutorial-pagination__btn tutorial-pagination__next" href="{{navprefix}}/tutorials/spottercode-embed/set-up-spottercode">Next &rarr;</a>
</div>
++++
