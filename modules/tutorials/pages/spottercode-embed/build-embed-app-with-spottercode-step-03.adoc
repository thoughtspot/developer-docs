= Step 3: Embed Spotter: Extend it with conversational analytics
:toc!:
:linkattrs:
:sectanchors:
:page-title: Step 3: Embed Spotter: Extend it with conversational analytics
...
The dashboard is in place. Now for the second use case: hosts can ask follow-up questions in their own words instead of hunting through Liveboard filters.
