...
:page-pageid: spottercode-embed__embed-spotter
...
<a class="tutorial-pagination__btn tutorial-pagination__prev" href="{{navprefix}}/tutorials/spottercode-embed/embed-liveboard-view">&larr; Previous</a>
<a class="tutorial-pagination__btn tutorial-pagination__next" href="{{navprefix}}/tutorials/spottercode-embed/troubleshooting">Next &rarr;</a>
</div>
++++
