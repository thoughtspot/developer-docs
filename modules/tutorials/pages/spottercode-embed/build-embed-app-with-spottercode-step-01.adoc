...
:page-pageid: spottercode-embed__set-up-spottercode
...
<a class="tutorial-pagination__btn tutorial-pagination__next" href="{{navprefix}}/tutorials/spottercode-embed/embed-liveboard-view">Next &rarr;</a>
</div>
++++
