...
The following actions are available for the contextual menu of the ThoughtSpot visualizations. These actions are available when you click on the chart:
