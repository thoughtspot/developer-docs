...
It is the most seamless method of single sign-on (SSO) but the actual *authentication* of the user is performed by the web application, requiring unique effort by the developer building the ThoughtSpot integration.

The Trusted authentication supports cookie-based and cookieless authentication. 
