...
This is useful for xref:rest-apiv2-reference.adoc#_data[data] and rest-apiv2-reference.adoc#_reports[reports] endpoints that have row-level security or other filtering applied based on the user account itself.
