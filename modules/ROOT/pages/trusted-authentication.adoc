...
This is useful for xref:rest-apiv2-reference[data] and xref:rest-apiv2-reference#_reports[reports] endpoints that have row-level security or other filtering applied based on the user account itself.
