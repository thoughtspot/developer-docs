...
For information about the LWC plug-in installation and setup, see link:https://docs.thoughtspot.com/software/latest/salesforce-plugin[Integration Guide, window=_blank].
