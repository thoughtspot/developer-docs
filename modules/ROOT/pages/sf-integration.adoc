...
NOTE: we have a team of embedding engineers who can help you
====
...
Authentication is a critical component of embedding ThoughtSpot in Salesforce. The two primary options are:
