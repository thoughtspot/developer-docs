...
** The js file will communicate with  your ThoughtSpot cluster and use the ThoughtSpot SDK to embed your objects. 
** Variables set in the meta.xml will be tracked and applied in the SDK initialization
** You must import the ThoughtSpot SDK as a static resource in Salesforce.  Get the latest NPM version link:https://cdn.jsdelivr.net/npm/@thoughtspot/visual-embed-sdk/dist/tsembed.js[here]. 
