...
* For centralized control of object access and to restrict user access to specific objects, ThoughtSpot recommends using the link:https://docs.thoughtspot.com/software/latest/security-data-object#object_security[Object security, window=_blank] method.
