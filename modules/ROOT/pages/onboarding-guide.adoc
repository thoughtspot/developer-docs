...
__Log in ThoughtSpot and check if you can access the **Develop** page. To embed ThoughtSpot content in your app, you need admin or *Has Developer privilege* privilege (DEVELOPER access). +
...
__Don't worry if you're using the Free Trial account. We have already connected a sample warehouse for you. If you plan to embed a Liveboard or Visualization, make sure these objects are available on your instance.__
