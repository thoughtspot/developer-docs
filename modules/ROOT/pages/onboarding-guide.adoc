...
In addition to this quickstart guide, there is a more complete xref:tse-fundamentals-intro.adoc[hands-on embedding fundamentals tutorial] available as well.
