...
[NOTE]
On ThoughtSpot instances with 9.8.0.cl or earlier release version, the `name` string supports only [a-z], [A-Z], [0-9], and [-]. Space and other special characters are not supported.
