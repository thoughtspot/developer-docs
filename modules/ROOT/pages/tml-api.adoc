...
By default, the API request uses v1 schema for Worksheets. If you are using link:https://docs.thoughtspot.com/software/latest/models[Models], set `export_schema_version` to `v2`. | `v1` +
|`export_dependent` +
