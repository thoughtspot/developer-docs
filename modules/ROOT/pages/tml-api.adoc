...
////
|`export_dependent`|__Boolean__. Includes or excludes tables of referenced connection objects during export. | `false`
|`export_connection_as_dependent`| __Boolean__. Includes or excludes dependent connection of referenced objects during export.| `false`
////
