...
For more information about the API request and response, see xref:authentication.adoc#_generate_a_custom_token_for_abac_implementation[Get tokens with custom rules and filter conditions].
