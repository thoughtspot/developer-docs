...
The log API endpoint allows you to fetch xref:audit-logs.adoc[security audit logs] programmatically from the ThoughtSpot system.
...
== Example response
The following example shows some of the security audit events returned in the API response. For more information about the audited events, contents of the log, and examples, see xref:audit-logs.adocs[Audit logs].
