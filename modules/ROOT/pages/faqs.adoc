...
[%collapsible]
====
A ThoughtSpot Liveboard is a collection of charts and tables saved by a user and presented as a dashboard in the UI for live analytics.
====
...
For more information, see xref:intro-embed.adoc[Embedded analytics with ThoughtSpot Embedded].

====

.What features are available with ThoughtSpot Embedded license?
[%collapsible]
====
