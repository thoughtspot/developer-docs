...
We need to provide the svgs with the ids that we want to override .
For eg the above svg looks like this. :
...
here the id rd-icon-chart says its overriding this icon


And it overrides it like so…



Users can find the id of the icon they want to override by inspecting it.
