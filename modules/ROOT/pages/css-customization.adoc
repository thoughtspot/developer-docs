...
__Not supported in 10.0.0.sw and later versions__| URL path of the search icon on the header bar.
|`--ts-var-sage-bar-img-color` +
__Not supported in 10.0.0.sw and later versions__ | Color of the search icon on the header bar.
|`--ts-var-sage-bar-img-visibility` +
__Not supported in 10.0.0.sw and later versions__ | Visibility of the search icon on the header bar.
|======
