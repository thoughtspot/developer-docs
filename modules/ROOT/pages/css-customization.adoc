...
. Go to image:./images/app_switcher.png[the app switcher menu] > *Develop* > *Visual Embed* > *Playground*.
...
. Add the SVG hosting domain to the *CSP connect-src domains* allowlist on the image:./images/app_switcher.png[the app switcher menu] > *Develop* > *Security Settings* page. For more information, see xref:security-settings.adoc#csp-connect-src[Security Settings].
