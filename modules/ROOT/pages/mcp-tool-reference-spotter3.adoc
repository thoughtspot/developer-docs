...
`search_objects` tool is independent of the analysis session workflow. Tt does not require a session and does not need to be called before `create_analysis_session`.
