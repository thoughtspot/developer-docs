...
For a complete list of `SearchEmbed` attributes and events, see the following pages:
...
----
For a complete list of `LiveboardEmbed` attributes and events, see the following pages:
...
* xref:embed-events.adoc[Interact with events]
