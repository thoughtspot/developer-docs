...
[#noteTiles]
=== Add Note tiles
You can add a link:https://docs.thoughtspot.com/software/latest/liveboard-notes[Liveboard Note tile, window=_blank] with custom text, images, and links on an embedded Liveboard.
...
Embedding application users can also apply filters across visualizations using the link:https://docs.thoughtspot.com/software/latest/liveboard-filters-cross[cross-filter feature, window=_blank].
...
For more information, see link:https://docs.thoughtspot.com/software/latest/liveboard-grouping-styling[Liveboard grouping and styling, window=_blank].
