...
////
Starting 10.1.0.cl, the link:https://docs.thoughtspot.com/cloud/latest/deprecation#_removed_in_10_1_0_cl[classic liveboard experience has been deprecated].
+
////
