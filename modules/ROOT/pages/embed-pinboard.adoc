...
Starting from 10.1.0.sw, the link:https://docs.thoughtspot.com/software/latest/deprecation#_removed_in_10_1_0_cl[classic experience for liveboards has been deprecated].
