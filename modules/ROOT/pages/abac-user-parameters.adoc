...
The ABAC message is encoded in JSON Web Token (JWT) format, using the existing ThoughtSpot V2.0 REST API Access Tokens (which are already OAuth JWT tokens)
