...
>>>>>>> e282caa... Typo fixes and SCAL-219823 updates
====
...
Filters and parameters must be *persisted* for them to apply when using xref:trusted-authenication.adoc#_cookie_based_vs_cookieless_authentication[cookie-based trusted authentication] or scheduled reports.
