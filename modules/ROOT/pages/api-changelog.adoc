...
Sets Liveboard header in a fixed position when set to `true`
* `hideLiveboardHeader` +
...
|[tag greenBackground]#NEW FEATURE# a|The new version of the SDK supports emitting the following events and triggering actions in the embedding application:
...
For more information, see xref:HostEvent.adoc[EmbedEvent].
