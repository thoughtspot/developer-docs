...
The Visual Embed SDK now supports embedding Spotter Agent feature without a body in a React app. For ease of implementation, the SDK also provides a custom React hook, `useSpotterAgent`.
