...
For more information, see xref:full-embed.adoc#_block_access_to_non_embedded_thoughtspot_instance[Block access to non-embedded ThoughtSpot application context].
|====
...
For more information, see xref:embed-action-ref.adoc[Action reference].
|[tag orangeBackground]#MODIFIED# |The SDK now supports omitting and executing a search query in xref:events-ref.adoc#hostEventSearch[`HostEvent.Search`].
