...
The SDK includes the following parameters, action IDs, and events to customizing Spotter embed experience.
...
* Action IDs for customizing the visibility and status of the actions in the embedded  Spotter interface:
...
** `Action.SpotterPastChatBanner` for banner in the chat history sidebar
