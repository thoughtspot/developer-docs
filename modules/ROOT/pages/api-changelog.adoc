...
[width="100%" cols="1,4"]
|====
|[tag greenBackground]#NEW FEATURE# a| The SDK includes the `AnswerService` class to trigger answer service provided with the custom action payload.
...
Gets the Answer session for a Search Answer or Liveboard Visualization.
