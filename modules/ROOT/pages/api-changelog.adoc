...
[width="100%" cols="1,4"]
|====
|[tag greenBackground]#NEW FEATURE#  a| Customizing homepage Search experience
a|The SDK now provides the `isUnifiedSearchExperienceEnabled` setting to customize the Search experience on ThoughtSpot Home page for embedding application users:
