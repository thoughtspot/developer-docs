...
|`orgScope` __Optional__|Query parameter|__String__. The Org scope. Not applicable to ThoughtSpot Software deployments.
|===
...
////
If you are making this API request for a user that belongs to a different Org than the one you are currently logged in to, specify `ALL` to authorize the cross-Org operation.
...
|`orgScope`|Query|__String__. The Org scope. Not applicable to ThoughtSpot Software deployments.
|===
