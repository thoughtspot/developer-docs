...
[NOTE]
====
The IAMv2 users have an additional user state, `SUSPENDED` in the user properties. For more information, see xref:https://developers.thoughtspot.com/docs/api-user-management[User migration to IAMv2]
====
...
[NOTE]
====
The `content` JSON map allows administrators to update the user account status to states such as `ACTIVE`, or `PENDING`. IAMv2 users also have an additional `SUSPENDED` user state. For more information, see xref:https://developers.thoughtspot.com/docs/api-user-management[User migration to IAMv2]
====
