...
a|xref:deprecated-features.adoc#_data_panel_experience_classic[Data panel experience (Classic)] |ThoughtSpot Cloud 26.4.0.cl and later | April 2026 | August 2026
