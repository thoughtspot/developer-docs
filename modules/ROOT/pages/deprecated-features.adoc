...
|December 2024 | June 2025 __(tentative)__
...
* ThoughtSpot Software 10.6.0.sw and later |July 2024|September 2024
...
[#IAMv1]
== IAMv1
Identity and Access Management (IAMv1) will be deprecated for all ThoughtSpot embedded customers tentatively in 10.8.0.cl. IAMv2 is being enabled for customers as part of maintenance windows for all ThoughtSpot embedded customers 10.4.0.cl onwards.

Effective from::
* ThoughtSpot Cloud 10.8.0.cl

Recommended action::
Ensure you are ready for migration by reviewing and following the link:https://docs.thoughtspot.com/cloud/latest/okta-iam#_before_migrating_to_iam_v2[steps in the documentation] so that there is no login disruption for your users after migration. For more information, see link:https://docs.thoughtspot.com/cloud/latest/okta-iam[Identity and Access Management V2]. Accept in-product notifications for IAM updates. Please contact link:https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support] if you have any questions.
