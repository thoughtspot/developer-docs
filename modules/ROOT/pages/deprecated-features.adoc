...
a|xref:deprecated-features.adoc#liveboardDiscoverable[Make this Liveboard discoverable checkbox]
...
== Make this Liveboard discoverable checkbox
The *Make this Liveboard discoverable* checkbox that appears in the Liveboard and Answer create, save, and share object UI workflows is deprecated and will be removed in ThoughtSpot Cloud 26.8.0.cl.
