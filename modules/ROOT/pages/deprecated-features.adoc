...
|xref:deprecated-features.adoc#_classic_experience_for_liveboards_answers_and_spotiq[Classic experience for Liveboards, Answers, and SpotIQ, window=_blank] a|Application UI +
...
|xref:deprecated-features.adoc#_deprecated_parameter_in_rest_api_v2_0_authentication_token_endpoints[*jwt_user_options*] parameter a| REST API v2.0 authentication token endpoints
...
|xref:deprecated-features.adoc#_deprecation_of_rest_api_v2_endpoints[REST API v2 ^Beta^ endpoints]|REST API|September, 2022| January, 2023
||||
|=====
