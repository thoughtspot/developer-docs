...
== Data panel experience (Classic)
The classic data panel experience in Search and Answer pages will be deprecated in 26.4.0.cl. The new data panel experience will replace the classic version to provide an improved user experience, including features such as query sets, custom groups, and filtering options.
