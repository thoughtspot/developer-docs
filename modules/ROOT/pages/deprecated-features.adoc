...
The REST API v1 Playground experience that is currently available from the *Develop* page of ThoughtSpot UI will be deprecated in the 10.14.0.cl release version.

Impact on your instance::
This change only removes the REST API v1 Playground from the *Develop* page in the ThoughtSpot UI. The REST API v1 endpoints will remain available for API calls from client applications and will continue to function as usual.
