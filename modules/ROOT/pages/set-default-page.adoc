...
:page-title: Customize the default page and navigation routes
...
The `path` parameter allows setting the default ThoughtSpot application page using URL path. Valid strings for the `path` parameter are: 
