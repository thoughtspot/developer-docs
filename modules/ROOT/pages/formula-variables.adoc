...
You can use the formula variables for the following purposes:
...
* For personalized analytics with filtering and calculations without duplicating objects or hardcoding values.
