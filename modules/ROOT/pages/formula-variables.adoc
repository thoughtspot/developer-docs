...
Formula variables are a type of template variable in ThoughtSpot that enable dynamic and context-aware logic Row Level Security (RLS) rules.
...
* In Attribute-Based Access Control (ABAC) implementation to configure security entitlements for a user via JWT tokens.
