...
ThoughtSpot Software: __10.10.0.sw or later__  a| +++<a href="{{navprefix}}/restV2-playground?apiResourceId=http%2Fapi-endpoints%2Fconnection-configurations%2Fcreate-connection-configuration" id="preview-in-playground">Try it out</a>+++
...
|ThoughtSpot Cloud: __10.12.0.cl or later__ +
ThoughtSpot Software: __10.10.0.sw or later__  a| +++<a href="{{navprefix}}/restV2-playground?apiResourceId=http%2Fapi-endpoints%2Fconnection-configurations%2Fconnection-configuration-search" id="preview-in-playground">Try it out</a>+++
...
Deletes the connection configuration.
...
|ThoughtSpot Cloud: __10.10.0.cl or later__  a| +++<a href="{{navprefix}}/restV2-playground?apiResourceId=http%2Fapi-endpoints%2Femail-customization%2Fdelete-email-customization" id="preview-in-playground">Try it out</a>+++
