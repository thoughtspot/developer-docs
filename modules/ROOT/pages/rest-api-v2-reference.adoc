...
Creates the customized configuration for the notification email.

|ThoughtSpot Cloud: __10.10.0.cl or later__ +
ThoughtSpot Software: __10.10.0.sw or later__  a| +++<a href="{{navprefix}}/restV2-playground?apiResourceId=http%2Fapi-endpoints%2Femail-customisation%2Fcreate-email-customisation" id="preview-in-playground">Try it out</a>+++

a|`POST /api/rest/2.0/customization/email/{template_identifier}/delete`

Deletes the existing customized configuration set for the notification email.

|ThoughtSpot Cloud: __10.10.0.cl or later__ +
ThoughtSpot Software: __10.10.0.sw or later__  a| +++<a href="{{navprefix}}/restV2-playground?apiResourceId=http%2Fapi-endpoints%2Femail-customisation%2Fdelete-email-customisation" id="preview-in-playground">Try it out</a>+++

a|`POST /api/rest/2.0/customization/email/search` +

Searches the customized configuration set for the notification email.
...
Validates the customized configuration set for the notification email.
...
a| `POST /api/rest/2.0/customization/email/validate` +
Updates a connection object.
a|ThoughtSpot Cloud: __10.10.0.cl or later__ +
ThoughtSpot Software: __10.7.0.sw or later__   a|
+++<a href="{{navprefix}}/restV2-playground?apiResourceId=http%2Fapi-endpoints%2Fconnections%2Fupdate-connection-v2" id="preview-in-playground">Try it out </a>+++
|=====
--
