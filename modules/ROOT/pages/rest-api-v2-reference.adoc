...
Converts a Worksheet to a Model. |ThoughtSpot Cloud: __10.6.0.cl or later__ + a| +++<a href="{{navprefix}}/restV2-playground?apiResourceId=http%2Fapi-endpoints%2Fmetadata%2Fconvert-worksheet-to-model" id="preview-in-playground">Try it out</a>+++
