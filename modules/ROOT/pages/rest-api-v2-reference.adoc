...
a|`POST /api/rest/2.0/system/security-settings/configure` [beta betaBackground]^Beta^ +
...
a|`POST /api/rest/2.0/system/security-settings/search` [beta betaBackground]^Beta^ +
