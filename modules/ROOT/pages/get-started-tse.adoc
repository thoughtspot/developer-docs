...
* With Free Trial, you can load your own data and evaluate embedded analytics features for a period of 14 days, and then transition to a paid account.
...
+
You can upgrade your license by clicking **Upgrade now** and initiating an upgrade request at any time during the trial period or when trial period expires.

+
[.bordered]
image::./images/trial-cluster-tse-license.png[]
 
 . To start the upgrade process and unlock features, click on a locked menu option on the *Develop* > **Customization** page, and then click **Upgrade**.
