...
// NOTE TO WRITER: The commented-out table above (within ////) contains a V4 column that was not yet published. Verify with engineering whether the V4 column is ready to be uncommented and published for 26.8.0.cl.

== Control the visibility of home page modules

You can use the `hiddenHomepageModules` property to show or hide specific modules on the modular home page. The `HomepageModule` enum provides the list of available modules.

The following table lists the allowed values for `hiddenHomepageModules`:
...
The KPI watchlist module.
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomepageModule.Trending` +
The trending Liveboards and Answers module.
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported
...
The My Library module.
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomepageModule.Learning` +
The learning and onboarding module.
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomepageModule.InContextSpotter` +
The Spotter panel on the home page.
| [tag redBackground tick]#x# Not supported
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
|===

// NOTE TO WRITER: Verify the complete list of HomepageModule enum values against the SDK source for 26.8.0.cl and add any missing entries above.
