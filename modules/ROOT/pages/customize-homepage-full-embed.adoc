...
// NOTE TO WRITER: The previous notice read "will be deprecated in an upcoming release in 2026". This has been updated to confirm deprecation is effective 26.8.0.cl. Verify with the product team before publishing.
====
...
Use the `hiddenHomepageModules` property in the SDK to hide specific modules on the home page. The allowed values for `hiddenHomepageModules` are listed in the following table:
...
To show or hide the *Watchlist* module.
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomepageModule.MyLibrary` +
To show or hide the *My Library* module.
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomepageModule.Trending` +
To show or hide the *Trending* module.
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomepageModule.Learning` +
To show or hide the *Learning* module.
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomepageModule.Favorites` +
To show or hide the *Favorites* module.
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomepageModule.SearchBar` +
To show or hide the search bar on the home page.
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomepageModule.Spotter` +
To show or hide the Spotter interface on the home page.
| [tag redBackground tick]#x# Not supported
| [tag redBackground tick]#x# Not supported
| [tag greenBackground tick]#✓#  Supported
|===
