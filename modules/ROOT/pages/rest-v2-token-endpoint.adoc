...
ThoughtSpot provides different REST API endpoints for developers and administrators to issue authentication tokens to end users.
...
**Use case**: Authenticates users with standard RLS rules and object permissions, administered via the user's properties and their group memberships. +
