...
To preview the Natural Language Search embed and customization features, use the +++<a href="{{previewPrefix}}/playground/search" window="_blank">Visual Embed Playground</a>+++.
