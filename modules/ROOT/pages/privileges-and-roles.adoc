...
If RBAC is not enabled, administrators can configure link:https://docs.thoughtspot.com/cloud/latest/groups-privileges[privileges, target=_blank] and assign it directly to groups.
