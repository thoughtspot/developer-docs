...
The legacy JWT ABAC implementation methods will be deprecated and removed in a future version. These legacy methods will not receive new enhancements. Therefore, we recommend migrating your existing deployments to xref:abac_rls-variables.adoc[ABAC via RLS] and testing the rollout before the legacy methods are removed.
