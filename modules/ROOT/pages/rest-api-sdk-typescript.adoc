...
|Version 2.0.2 |
ThoughtSpot Cloud 9.6.0.cl or later a| link:https://github.com/thoughtspot/rest-api-sdk/blob/release/sdks/typescript/ThoughtSpotRestApi.md[REST API SDK library for TypeScript, window=_blank]  +
