...
|`orgScope`|__Optional__. The Org scope. Not applicable to ThoughtSpot Software deployments.
|====

////
To query user metadata for all Orgs on your cluster, set the Org scope to `ALL`. If the Org scope is not set, ThoughtSpot returns metadata for only the user objects in your current Org context.
////
