...
For more information about the tool calls, input parameters, and response output, see xref:mcp-tool-reference-guide.adoc#_mcp_server_with_spotter_3[MCP tool reference guide].
