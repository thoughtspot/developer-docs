...
By default, the Sample Retail link:https://docs.thoughtspot.com/software/latest/system-worksheet[system Worksheet, window=_blank] includes a Search Assist lesson with a predefined set of questions and instructions to guide your application users.
