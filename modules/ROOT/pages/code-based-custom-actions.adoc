...
=== Add callback to a custom action

To add a callback to a custom action when it is clicked, use the Visual Embed SDK's .on method with EmbedEvent.CustomAction.
