...
[NOTE]
Code based custom action for Liveboards do not return data in their callback. To get data from a Liveboard object and its visualizations use the `POST /api/rest/2.0/metadata/liveboard/data` API endpoint.
