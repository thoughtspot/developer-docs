...
+
++++
<a href="{{previewPrefix}}/playground/answer?modifyActions=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
+
++++
<a href="{{previewPrefix}}/playground/answer?runtimeFilters=true" id="preview-in-playground" window="_blank">Try it in Playground</a>
++++
...
+
[.bordered]
image::./images/embed-viz.png[Visualization embed]
