...
--
[IMPORTANT]
*Deprecation notice — 26.8.0.cl:* The classic (V1) experience and V2 experience modes are deprecated as of ThoughtSpot Cloud 26.8.0.cl. All embedded applications now render the V3 navigation experience by default. SDK properties targeting V1 or V2 navigation are silently ignored. Update your `AppViewConfig` to use `discoveryExperience` with `primaryNavbarVersion: PrimaryNavbarVersion.Sliding`. For migration guidance, see xref:full-app-customize.adoc[Customize full application embedding].
--
...
To show or hide the *Favorites* menu in the *Insights* panel.
| __Not applicable__
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomeLeftNavItem.MyLibrary` +
To show or hide the *My Library* menu item in the *Insights* panel.
| __Not applicable__
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported

| `HomeLeftNavItem.Learning` +
To show or hide the *Learning* menu item in the *Insights* panel.
| __Not applicable__
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported
|===

// NOTE TO WRITER: Verify the complete list of HomeLeftNavItem enum values above is accurate for 26.8.0.cl.
// The original file may have additional values beyond what is shown here — confirm against the SDK enum definition.
