...
--
[IMPORTANT]
The classic (V1) experience and V2 experience modes are deprecated as of ThoughtSpot Cloud 26.8.0.cl. Therefore, ThoughtSpot recommends upgrading the UI experience of your full application embedding to the V3 experience.
--

// SOURCE: visual-embed-sdk PR #530 (commit fde6b3ba0a58) | SCAL-312731
// TODO: [WRITER] Confirm SDK version tag — expected SDK 1.51.0 | ThoughtSpot Cloud 26.8.0.cl
[NOTE]
====
Starting from Visual Embed SDK 1.51.0, `navigationVersion=v3` is sent as a default URL parameter even when `discoveryExperience` is not explicitly configured. Applications that relied on V1 or V2 navigation as the default will now receive the V3 experience without requiring a code change.
====
...
// SOURCE: visual-embed-sdk PR #530 (commit fde6b3ba0a58) | SCAL-312731
The classic (V1) and Modular (V2) home page experiences are deprecated as of ThoughtSpot Cloud 26.8.0.cl. This attribute applies to V3 (`ModularWithStylingChanges`) and V4 (`Focused`) home page experiences.
