...
If you want to include the help menu and link:https://docs.thoughtspot.com/software/latest/customize-help[add custom links, window=_blank] to it, ensure that the top navigation bar is visible and `disableProfileAndHelp` is set to `false`.
...
To add custom links to the help menu, use the customization options in the **Admin settings** > **Help customization** page. For more information, refer to the link:https://docs.thoughtspot.com/software/latest/customize-help[ThoughtSpot Product Documentation].
