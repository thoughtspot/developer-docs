...
| `HomeLeftNavItem.Learn` +
To show or hide the *Learning* module in the *Insights* panel.
| __Not applicable__
| [tag greenBackground tick]#✓#  Supported
| [tag greenBackground tick]#✓#  Supported
|===

// NOTE TO WRITER: Verify the complete list of HomeLeftNavItem enum values against the SDK source for 26.8.0.cl and add any missing entries above.
