...
* **Bucket name**: Name of the S3 bucket. For example, `ts-webhook-x7k9m2p4q1`.
...
| Verify that the webhook is enabled and that alert condition for the scheduled event is met. Contact ThoughtSpot Support if the issue persists.
