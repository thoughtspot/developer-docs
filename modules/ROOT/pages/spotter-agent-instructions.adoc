...
* Visit the +++<a href="{{navprefix}}/restV2-playground?apiResourceId=http%2Fapi-endpoints%2Fai%2Fset-agent-instructions">REST API v2.0 Playground</a>+++ to test the set agent instructions endpoint.
* Visit the +++<a href="{{navprefix}}/restV2-playground?apiResourceId=http%2Fapi-endpoints%2Fai%2Fget-agent-instructions">REST API v2.0 Playground</a>+++ to test the get agent instructions endpoint.
