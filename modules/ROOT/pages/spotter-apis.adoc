...
ThoughtSpot provides a set of REST APIs to interact create a conversation session with Spotter, ask follow-up questions, and generate Answers for their analytic queries.
