...
//__Limited availability on ThoughtSpot Cloud instances from 10.15.0.cl onwards. Please contact ThoughtSpot Support to enable this feature on your instance__.
|=====
...
[NOTE]
====
The Get data source suggestions feature is in beta and available from 10.15.0.cl onwards.
====
