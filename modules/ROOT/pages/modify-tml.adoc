...
When doing development and deployment with TML, xref:variables.adoc[variables] and xref:deploy-with-tml-apis.adoc#obj_id[obj_id] make TML portable across different Orgs and ThoughtSpot instances. 
