...
|`FAILED`
|The task failed.
Possible causes: the queue was full at submission time, a policy-level failure occurred, or an unrecoverable error was encountered during processing.
|====

*Recommended polling intervals:*

* Minimum polling interval: 30 seconds.
* For large tasks: poll every 1 minute. Large tasks take proportionally longer to complete.
