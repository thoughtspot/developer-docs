...
The TML syntax varies per object type. However, all TMLs follow a general pattern that allow programmatic edits. See the following pages for the detailed syntax of TML files for each object type:
