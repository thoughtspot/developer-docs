...
|`skip_diff_check` +
__Optional__
10.6.0.cl |__Boolean__. Skips diff check before processing TMLs for imports. |`false`
|`enable_large_metadata_validation` +
__Optional__
10.5.0.cl |__Boolean__. Enables validation for large metadata objects. |`false`
////
