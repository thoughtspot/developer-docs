...
Personalized Views support improved portability across ThoughtSpot environments. Two new TML fields and updated import merge logic make it easier to migrate Personalized Views between environments without creating duplicates.
