...
Specifies the schema version to use during TML export. For link:https://docs.thoughtspot.com/software/latest/models[Models, window=_blank], set `export_schema_version` to v2.
...
When set to `true`, export column aliases of the Model if the data Model includes any link:https://docs.thoughtspot.com/software/latest/column-aliases[column aliases, window=_blank].
