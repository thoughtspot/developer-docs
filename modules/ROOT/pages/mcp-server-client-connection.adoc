...
Some LLM clients such as Claude support skills. Skills are packaged sets of instructions and best practices that an agent can load on demand to perform specific tasks more reliably.
