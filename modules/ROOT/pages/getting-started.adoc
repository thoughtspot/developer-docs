...
The following sections describe how to embed a ThoughtSpot component using Visual Embed SDK. For additional guidance refer to the xref:tse-fundamentals-intro.adoc[Embedding fundamentals tutorial].
