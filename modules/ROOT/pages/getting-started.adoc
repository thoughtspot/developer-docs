...
+
++++
<a href="?pageid=embed-liveboard" id="preview-in-playground" window="_blank">Embed a Liveboard</a>
++++
...
+
++++
<a href="?pageid=embed-nls" id="preview-in-playground" window="_blank">Embed Natural Language Search</a>
++++
...
+
++++
<a href="?pageid=full-embed" id="preview-in-playground" window="_blank">Embed full ThoughtSpot application</a>
++++
...
+
++++
<a href="?pageid=search-embed" id="preview-in-playground" window="_blank">Embed Search page</a>
++++
...
+
++++
<a href="?pageid=embed-searchbar" id="preview-in-playground" window="_blank">Embed Search bar</a>
++++
