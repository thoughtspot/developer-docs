...
////
Once your environments are configured, you can xref:version_control.adoc#_moving_tml_changes_between_environments[move data models and content] from the initial "dev environment" to any other environment using the xref:git-rest-api-guide.adoc[Git integration REST APIs].
////
