...
ThoughtSpot provides a GitHub-based link:https://docs.thoughtspot.com/software/latest/git-version-control[automated version control in the UI] for Liveboards and answers or a customized process can be built using the TML Export API to any Git provider.
