...
* link:https://docs.thoughtspot.com/software/latest/connections-amazon-athena[Amazon Athena^]

* link:https://docs.thoughtspot.com/software/latest/connections-amazon-aurora-mysql[Amazon Aurora MySQL^]

* link:https://docs.thoughtspot.com/software/latest/connections-amazon-aurora-postgresql[Amazon Aurora PostgreSQL^]

* link:https://docs.thoughtspot.com/software/latest/connections-amazon-rds-mysql[Amazon RDS MySQL^]

* link:https://docs.thoughtspot.com/software/latest/connections-amazon-rds-postgresql[Amazon RDS PostgreSQL^]

* link:https://docs.thoughtspot.com/software/latest/connections-redshift[Amazon Redshift^]

* link:https://docs.thoughtspot.com/software/latest/connections-synapse[Azure Synapse^]

* link:https://docs.thoughtspot.com/software/latest/connections-databricks[Databricks^]

* link:https://docs.thoughtspot.com/software/latest/connections-denodo[Denodo^]

* link:https://docs.thoughtspot.com/software/latest/connections-dremio[Dremio^]

* link:https://docs.thoughtspot.com/software/latest/connections-genericjdbc[Generic JDBC^]

* link:https://docs.thoughtspot.com/software/latest/connections-google-alloydb-postgresql[Google AlloyDB for PostgreSQL^]

* link:https://docs.thoughtspot.com/software/latest/connections-gbq[Google BigQuery^]

* link:https://docs.thoughtspot.com/software/latest/connections-google-cloud-sql-mysql[Google Cloud SQL for MySQL^]

* link:https://docs.thoughtspot.com/software/latest/connections-google-cloud-sql-postgresql[Google Cloud SQL for PostgreSQL^]

* link:https://docs.thoughtspot.com/software/latest/connections-google-cloud-sql-sql-server[Google Cloud SQL for SQL Server^]

* link:https://docs.thoughtspot.com/software/latest/connections-looker[Looker^]

* link:https://docs.thoughtspot.com/software/latest/connections-mode[Mode^]

* link:https://docs.thoughtspot.com/software/latest/connections-mysql[MySQL^]

* link:https://docs.thoughtspot.com/software/latest/connections-adw[Oracle^]

* link:https://docs.thoughtspot.com/software/latest/connections-postgresql[PostgreSQL^]

* link:https://docs.thoughtspot.com/software/latest/connections-presto[Presto^]

* link:https://docs.thoughtspot.com/software/latest/connections-hana[SAP HANA^]

* link:https://docs.thoughtspot.com/software/latest/connections-singlestore[SingleStore^]

* link:https://docs.thoughtspot.com/software/latest/connections-snowflake[Snowflake^]

* link:https://docs.thoughtspot.com/software/latest/connections-sql-server[SQL Server^]

* link:https://docs.thoughtspot.com/software/latest/connections-starburst[Starburst^]

* link:https://docs.thoughtspot.com/software/latest/connections-teradata[Teradata^]

* link:https://docs.thoughtspot.com/software/latest/connections-trino[Trino^]

This article describes the procedures for setting and managing data connections through the REST APIs. For information about how to set up a data connection, see link:link:https://docs.thoughtspot.com/software/latest/connections[Data Connections in ThoughtSpot, window=_blank].
...
To set up a *Redshift connection with OAuth*, see link:https://docs.thoughtspot.com/software/latest/connections-redshift-aws-idc-oauth[Configure AWS IDC OAuth for a Redshift connection, window=_blank] and link:https://docs.thoughtspot.com/software/latest/connections-redshift-azure-ad-oauth[Configure Azure AD external OAuth for a Redshift connection, window=_blank]
====
...
To set up a *Synapse connection with OAuth*, see link:https://docs.thoughtspot.com/software/latest/connections-synapse-oauth[Configure OAuth for a Synapse connection, window=_blank]
====
...
To set up a *Databricks connection with OAuth*, see link:https://docs.thoughtspot.com/software/latest/connections-databricks-oauth[Configure OAuth for a Databricks connection, window=_blank].
====
...
To set up a *Dremio connection with OAuth*, see link:https://docs.thoughtspot.com/software/latest/connections-dremio-oauth[Configure OAuth for a Dremio connection, window=_blank].
====
...
To set up a *Denodo connection with OAuth*, see link:https://docs.thoughtspot.com/software/latest/connections-denodo-oauth[Configure OAuth for a Denodo connection
, window=_blank].
...
* `oauth_pvt_key`
+
__String__. The secret key obtained for your BigQuery service account. To obtain the secret key, you must create a custom role in BigQuery and set up your service account. For more information, see link:link:https://docs.thoughtspot.com/software/latest/connections-gbq-prerequisites[BigQuery prerequisites, window=_blank].

To set up a *BigQuery connection with OAuth*, see link:https://docs.thoughtspot.com/software/latest/connections-gbq-oauth[Configure OAuth for a Google BigQuery connection, window=_blank].
////
* `state`
...
To set up a *Looker connection with OAuth*, see link:https://docs.thoughtspot.com/software/latest/connections-looker-add#_connecting_to_looker[Connecting to Looker, window=_blank].
====
...
To set up a *Starburst connection with OAuth*, see link:https://docs.thoughtspot.com/software/latest/connections-starburst-oauth[Configure OAuth for a Starburst connection, window=_blank]
====
...
To set up a *Snowflake connection with OAuth*, see link:https://docs.thoughtspot.com/software/latest/connections-snowflake-oauth[Configure internal OAuth for a Snowflake connection, window=_blank].
====
...
For information on integrating with dbt using the *Data Workspace* option in the UI, see link:https://docs.thoughtspot.com/software/latest/dbt-integration[Integrate with dbt, window=_blank].
...
* link:https://docs.thoughtspot.com/software/latest/catalog-integration[Alation, window=_blank]
* link:https://docs.thoughtspot.com/software/latest/catalog-integration-atlan[Atlan, window=_blank]
* link:https://docs.thoughtspot.com/software/latest/catalog-integration-collibra[Collibra, window=_blank]
...
* `EXTOAUTH` +
For data connections that have external OAuth set up. ThoughtSpot supports external OAuth with Microsoft Azure Active Directory (AD) and Okta for Snowflake data connections. For more information, see link:link:https://docs.thoughtspot.com/software/latest/connections-snowflake-okta-oauth[Configure Okta OAuth for a Snowflake connection, window=_blank] and link:link:https://docs.thoughtspot.com/software/latest/connections-snowflake-azure-ad-oauth[Configure Azure AD external OAuth for a Snowflake connection, window=_blank].
|==== 
