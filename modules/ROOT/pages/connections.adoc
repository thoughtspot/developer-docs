...
* https://docs.thoughtspot.com/cloud/latestconnections-google-cloud-sql-sql-server[Google Cloud SQL for SQL Server]
...
* https://docs.thoughtspot.com/cloud/latestconnections-presto[Presto]
