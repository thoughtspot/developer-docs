...
* link:https://docs.thoughtspot.com/software/latest/connections-snowflake-oauth[OAuth connections, window=_blank]: Individualized login to the data warehouse connection using OAuth, where security rules have already been implemented for each user.
