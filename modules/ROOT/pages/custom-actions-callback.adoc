...
Use the link:https://developers.thoughtspot.com/docs/Class_AnswerService[`AnswerService`, window=_blank] class to run GraphQL queries in the context of the Answer on which the custom action is  triggered.
