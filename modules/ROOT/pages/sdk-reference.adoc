...
include::link:{{navprefix}}/VisualEmbedSdk[Visual Embed SDK Reference]
...
Additional examples can be found at link:https://github.com/thoughtspot/ts_everywhere_resources[ThoughtSpot Embedded Resources on GitHub, window=_blank].
