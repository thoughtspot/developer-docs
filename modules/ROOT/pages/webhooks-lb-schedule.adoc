...
* xref:webhooks-lb-schedule.adoc#_configure_a_webhook_communication_channel[Configuring a webhook communication channel at the instance level or for a specific Org].
...
* `storage_config` +
Storage configuration parameters. If you have selected `AWS_S3`, specify the storage configuration parameters required for Amazon S3 integration. For more information, see xref:webhooks-s3-storage.adoc[S3 storage integration for webhook delivery].
|=====
