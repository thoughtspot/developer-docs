...
To optimize your user's experience when ThoughtSpot is embedded into your application, we recommend using the steps and methods described in this article.
