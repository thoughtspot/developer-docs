= Users, Groups, and Role privileges
:toc: true
:toclevels: 3
...
* xref:user-api.adoc[/tspublic/v1/user/] (REST API v1)
...
For more information, see link:https://docs.thoughtspot.com/cloud/latest/okta-iam[IAMv2 documentation, window=_blank].
