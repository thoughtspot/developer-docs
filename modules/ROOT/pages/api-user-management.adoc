...
* `PENDING`
+
This state is used for link:https://docs.thoughtspot.com/software/latest/okta-iam[Identity and Access Management v2 (IAMv2), window=_blank] users who have been sent a ThoughtSpot account activation email, but have not logged in to their instance yet.
...
* link:https://docs.thoughtspot.com/software/latest/user-account-activation-okta[Activate your account using IAMv2, window=_blank]
* link:https://docs.thoughtspot.com/software/latest/saml-okta[Managing authentication with SAML using IAMv2, window=_blank]
* link:https://docs.thoughtspot.com/software/latest/oidc-iamv2[Managing authentication with OIDC using IAMv2, window=_blank]
* link:https://docs.thoughtspot.com/software/latest/okta-iam[IAMv2 documentation, window=_blank]
...
To get a list of users assigned to a group, use the /api/rest/2.0/groups/search</a>  v2 endpoint or the xref:group-api.adoc#get-usersInGroup[/tspublic/v1/group/{groupid}/users] v1 endpoint.
...
For more information, see xref:roles.adoc[Role-based access control] and link:https://docs.thoughtspot.com/software/latest/rbac[ThoughtSpot Product documentation, window=_blank].
////