...
With link:https://docs.thoughtspot.com/cloud/latest/okta-iam[Identity and Access Management v2 (IAMv2)], users need to provide an email attribute for successful user creation.
