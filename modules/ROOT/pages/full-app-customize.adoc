...
[NOTE]
====
*Legacy reference — V1 and V2 experience:* The following sections are retained for reference. The classic (V1) and V2 experience modes are deprecated as of 26.8.0.cl. If you are still using V1 or V2, follow the migration guidance in this section to upgrade to V3 before your next release cycle.

// NOTE TO WRITER: Do not remove the V1/V2 upgrade sections below. They remain as a migration reference for customers who have not yet upgraded. Evaluate whether to archive this content in a separate legacy page in a future release.
====
...
// NOTE TO WRITER: The original file was truncated after this point. Please verify and restore the remaining content of this file (V2-to-V3 upgrade steps, UI customization options table, enable V4 focused home page experience section, and any other sections) from the source file on the main branch before publishing.
