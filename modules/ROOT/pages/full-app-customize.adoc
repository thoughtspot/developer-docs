...
For more information about the layout and UI elements in the V3 experience, refer to the link:https://docs.thoughtspot.com/software/latest/thoughtspot-homepage[ThoughtSpot Product Documentation, window=_blank].
