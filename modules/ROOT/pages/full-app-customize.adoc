...
* xref:full-app-customize.adoc#_upgrade_from_v1_to_v2_experience[V2 navigation and home page experience]
...
| V3 navigation with a modular home page that is similar to the V2 experience
...
xref:css-customization.adoc[CSS customization] allows overriding default styles in ThoughtSpot application pages. You can also use xref:_theme_builder[Theme Builder] to explore the available CSS variables.
