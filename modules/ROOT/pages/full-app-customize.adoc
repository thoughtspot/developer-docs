...
* xref:full-app-customize.adoc#_upgrade_to_the_v3_experience[V3 navigation and modular home page experience] (__Recommended__) 
* xref:full-app-customize.adoc#_upgrade_from_v1_to_v2_experience[V2 navigation experience and home page experience]
* V1 classic experience (__Default experience__) 

The key differences between the UI experience modes are described in the following table:
...
Before updating the UI experience, xref:full-app-customize.adoc#_ui_experience_modes[review key features and limitations] of each UI experience mode and the controls available in the Visual Embed SDK to customize the navigation and home page experience.
...
If you are using classic experience in your embed, ThoughtSpot recommends migrating directly to the V3 experience for an improved user interface, enhanced home page customization options, and navigation controls.
...
* Verify that customization settings are applied correctly.
...
Setting the `modularHomeExperience: true` in the SDK enables the V2 experience.
