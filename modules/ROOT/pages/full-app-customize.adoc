...
* xref:full-app-customize.adoc#_upgrade_to_the_v3_experience[V3 navigation and home page experience] (__Default and recommended from 26.8.0.cl__)
...
// NOTE TO WRITER: The V2 upgrade section below is retained intentionally for users who may still be on V1 and need step-by-step guidance for V2 → V3. Do not remove this section. Verify with the product team if any SDK examples in this section need updating for 26.8.0.cl.

==== Upgrade from the V2 experience to V3 experience [.version-badge.deprecated]#Deprecated#

[NOTE]
====
The V2 experience is deprecated as of 26.8.0.cl. The following section is retained for reference. If you are still on V2, follow this guidance to migrate to V3.
====