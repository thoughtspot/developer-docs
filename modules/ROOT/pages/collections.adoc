...
If the API request is successful, the object specified in the API request gets added to the Collection.
...
If the API request is successful, the object specified in the API request gets removed from the Collection.
...
If the API request is successful, the objects of the Collection get replaced with the objects in this API request.
