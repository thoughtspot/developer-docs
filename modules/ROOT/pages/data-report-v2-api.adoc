...
The default `file_format` is *CSV* [earlyAccess eaBackground]#Early Access#. If you do not have this feature enabled for your ThoughtSpot instance, please select an appropriate `file_format` to successfully download the report.
