...
You can download thw Answer data in the `PNG`, `PDF`, `CSV` and `XLSX` format. The default `file_format` is CSV.
...
For more information, see xref:runtime-parameters.adoc#_rest_api_v2[Apply runtime Parameter via REST API v2].
