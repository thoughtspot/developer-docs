...
However, due to the UI limitation within the REST API playground, these options will continue to be visible despite enabling the above settings. This should have no impact on your API operation.
