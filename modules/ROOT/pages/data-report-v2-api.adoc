...
. On the **Data workspace** > **Home** page, select the data object. For example, if the data source object is a Worksheet, click **Worksheets** and then open the Worksheet.
