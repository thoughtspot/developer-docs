...
[IMPORTANT]
====
* If the above settings are enabled on your instance, you will no longer be able to use the `include_cover_page`,`include_filter_page` within the `png_options`.
