...
:page-pageid: SpotterCode-prompt-guide
...
Recommended actions::
- Make your prompt as specific as possible. Specify the SDK version, the exact component, and the desired output. For best results, break down complex requests into smaller, sequential prompts. Refer to xref:spottercode-prompt-guidance.adoc[prompt examples and best practices] for tips.
