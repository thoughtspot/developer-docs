...
To customize the application domain URL that appears in the browser, contact ThoughtSpot support to initiate a URL change request. ThoughtSpot may require the following information to complete this operation:
