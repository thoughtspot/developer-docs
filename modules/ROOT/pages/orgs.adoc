...
[NOTE]
====
Prior to requestingPer Org Subdomain, all org names need to be DNS-friendly; otherwise, ThoughtSpot will return errors. You should review your Org names prior to the request and make sure they don't have spaces or other strange characters. The subdomains are case-sensitive and will match the Org names case at the time of the request.
====
