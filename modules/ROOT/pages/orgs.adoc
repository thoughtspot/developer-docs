...
For more information, see link:https://docs.thoughtspot.com/software/latest/orgs-overview#_all_org_scope[ThoughtSpot product documentation, window=_blank].
...
For SAML authentication, ensure that the Org support is enabled for SAML authentication. For more information, see link:https://docs.thoughtspot.com/software/latest/saml-group-mapping[ThoughtSpot Product Documentation].
