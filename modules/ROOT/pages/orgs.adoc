...
|Security settings (CORS and CSP for embedded instances)| [tag greyBackground tick]#–# |__CORS and CSP configuration via UI is supported only at the Primary Org (Org 0) level__
