...
For OIDC authentication, ensure that the Org support is enabled for OIDC authentication. For more information, see link:https://docs.thoughtspot.com/cloud/latest/authentication-integration[ThoughtSpot Product Documentation].
...
For more information on OIDC authentication, see ThoughtSpot Product Documentation.
