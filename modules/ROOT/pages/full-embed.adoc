...
* To enable Spotter in the full application embed, set the home page search bar mode to `HomePageSearchBarMode.AI_ANSWER`. For more information, see xref:customize-homepage-full-embed.adoc#_search_experience_on_home_page[Customize the search module on the home page].
====
