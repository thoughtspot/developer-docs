...
* The **Admin settings** and *Develop*, and *Analyst Studio* pages are not available in the full application embed.
...
+
Search Assist uses predefined queries and answers from the worksheet. Users with edit permissions to a worksheet can define Search Assist queries and answers to assist users with search.
