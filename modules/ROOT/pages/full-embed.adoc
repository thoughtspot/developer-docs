...
+
For more information about new navigation and homepage experience and customization controls for full application embedding, see xref:https://developers.thoughtspot.com/docs/full-app-customize[Customize full application embedding].
...
+
++++
<a href="{{previewPrefix}}/playground/fullApp?modifyActions=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
++++
<a href="{{previewPrefix}}/playground/fullApp?disableProfileAndHelp=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
+
++++
<a href="{{previewPrefix}}/playground/fullApp?showNavBar=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
+
++++
<a href="{{previewPrefix}}/playground/fullApp?runtimeFilters=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
+
++++
<a href="{{previewPrefix}}/playground/search?enableSearchAssist=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
