...
You need admin privileges to enable SAML SSO authentication. For detailed information on the steps to be followed to enable SAML
authentication on your ThoughtSpot instance, see this page link:https://docs.thoughtspot.com/cloud/9.10.0.cl/authentication-integration[Enable SAML authentication]
