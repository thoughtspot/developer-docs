...
== SAML authentication using IAMv2

You need admin privileges to enable SAML SSO authentication.

To enable SAML authentication on ThoughtSpot using IAMv2, follow the steps listed on this page
...
You can map your SAML groups from your IdP to your ThoughtSpot groups. This means that you do not have to manually recreate your groups in ThoughtSpot, if they are already present in your IdP.
