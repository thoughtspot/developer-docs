...
* Ensure that that xref:variables.adoc[variables are available] on your instance. Use the `/api/rest/2.0/template/variables/search` API to xref:variables.adoc#_get_details_of_variables[get a list of variables].
