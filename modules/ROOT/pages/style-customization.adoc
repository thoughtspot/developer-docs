...
*Style customization* menu in the image:./images/app_switcher.png[the app switcher menu] > *Admin* tab or  navigating to image:./images/app_switcher.png[the app switcher menu] > *Develop* > *Customizations* > *Styles*. To learn how to use these controls, see xref:customize-style.adoc[Customize layout and styles].
