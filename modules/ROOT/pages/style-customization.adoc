= Customize UI layout and styles
:toc: true
:toclevels: 1
...
*Style customization* menu in the **Admin settings** or *Develop* page in ThoughtSpot UI. For more information, see xref:customize-style.adoc[Customize layout and styles].
+
[NOTE]
====
