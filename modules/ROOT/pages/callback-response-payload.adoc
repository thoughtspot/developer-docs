...
The following example shows the data payload for a callback custom action in the primary action of a Liveboard:
...
The following example shows the data payload for a callback custom action in the *More* menu for Spotter:
