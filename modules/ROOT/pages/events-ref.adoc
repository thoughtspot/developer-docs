...
The following video shows how to register `HostEvent.RemoveColumn` event and remove a column from the search query string using the *Try* button:
...
[source,JavaScript]
----
searchEmbed.trigger(HostEvent.OpenFilter, { columnId: 'fe7d717d-7739-4cdf-a6b6-309e0d2a8408', name: 'Sales', type: 'INT64', dataType: 'ATTRIBUTE' })
----
====
--
