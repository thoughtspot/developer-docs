...
In the upcoming ThoughtSpot 10.3.0.cl release, the search experience on the **Home** page does not combine Natural Language Search and Object Search. As a result, Object Search will become the default search experience on the **Home** page, and Natural Language Search will be disabled by default.

If you are embedding the **Home** page of ThoughtSpot application, and you want to retain both the Object Search and Natural Language Search experience for your users, you need to make a few changes to your application experience. For more information, see xref:full-app-customize.adoc#_customize_search_experience_for_home_page[Customize Search experience for Home page].
