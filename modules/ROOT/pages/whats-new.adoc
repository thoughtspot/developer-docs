...
=== CSS variables for Liveboard styling and grouping
ThoughtSpot introduces new CSS variables for styling and grouping for Liveboards. You can use the following variables in your custom CSS:
