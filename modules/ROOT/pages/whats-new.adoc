...
You can now enable lazy loading of Liveboard visualizations when the `fullHeight` property is enabled. When set to `true`, the visualizations in the embedded Liveboard are loaded incrementally as the user scrolls the Liveboard page.
