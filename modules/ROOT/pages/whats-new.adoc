...
ThoughtSpot embedded users can now customize their automated email notifications for each Org through REST APIs v2. You can now customize features such as the company logo, style, and fonts, visibility of components in the template, and ThoughtSpot-specific content from all notification emails, thus ensuring a consistent brand experience.
