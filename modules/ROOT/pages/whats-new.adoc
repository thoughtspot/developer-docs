...
For more information, see xref:spottercode.adoc#_mcp_server_endpoints[SpotterCode skills] and xref:spottercode-integration.adoc#_authenticate_spottercode[Authenticate SpotterCode].
