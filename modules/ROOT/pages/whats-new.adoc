...
If you have embedding full application with Liveboards and Answers page, note the following changes:

* The *Edit TML*, *Export TML*, and *Import TML* actions that were available on selecting a Liveboard or Answer, are no longer available on the *Liveboards* and *Answers* listing page. The TML menu actions are available in the Liveboard and Answer pages. You can also use the import and export TML options available on the **Data Workspace** > **Utilities** page.
...
For information about the new features and enhancements introduced in Visual Embed SDK version 1.29.x and 1.31.0, see xref:api-changelog.adoc[Visual Embed changelog].
...
The Classic experience mode for Liveboards, SpotIQ, and Answers will not be available from ThoughtSpot Cloud 10.1.0.cl release onwards. For more information, see xref:deprecated-features.adoc#_classic_experience_for_liveboards_answers_and_spotiq[Deprecation announcements].
