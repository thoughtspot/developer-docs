...
After your instance is upgraded to 9.8.0.cl and if Custom Calendar is enabled on your instance, the data returned in the API response shows the date and time in the  `{"v":{"s":694252800}}` format.

If Custom Calendar is not enabled, the API output shows the date and time data in Epoch time format.
...
If Custom Calendar is enabled, the date and time data is shown in the following format:
----
