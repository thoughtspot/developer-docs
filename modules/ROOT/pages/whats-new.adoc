...
The new experience has a left-hand navigation, to go directly to your Liveboards, Answers, SpotIQ Analysis, and Monitor Subscriptions.
This new home page experience is disabled by default.

The navigation in the new experience is designed  in separate contextual sections designed specifically for the kind of user.
