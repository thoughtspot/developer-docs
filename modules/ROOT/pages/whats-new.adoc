...
For information about the new features and enhancements introduced 10.15.0.cl, see the link:https://developers.thoughtspot.com/docs/10.15.0.cl?pageid=whats-new[10.15.0.cl Developer Documentation].
