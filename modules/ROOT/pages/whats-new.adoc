...
* To understand changes to the API endpoints with this upgrade, see xref:https://developers.thoughtspot.com/docs/api-user-management[User migration to IAMv2]
