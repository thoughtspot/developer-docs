...
You can now embed ThoughtSpot Search page with Natural Language Search capability using the `SageEmbed` SDK package.  Natural Language Search allows your application users to search for data using natural language query strings. This feature also provides AI-suggested sample questions and popular queries to assist users in their data search operations.

Using `SageEmbed`, you can integrate ThoughtSpot Search data interface with Natural Language Search in your app and also customize the Search options as per your requirements.
