...
sections into a single focused view.
...
[discrete]
==== Visual Embed SDK
The Visual Embed SDK version 1.50.0 includes several new features
and enhancements. For more information, see the
xref:api-changelog.adoc[Visual Embed changelog].
