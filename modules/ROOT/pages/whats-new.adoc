...
If you are embedding the **Home** page of ThoughtSpot application, and you want to retain both the Object Search and Natural Language Search experience for your users, you need to make a few changes to your application experience. For more information, see xref:full-app-customize.adoc#_customize_search_experience_on_the_home_page[Customize Search experience for Home page].
