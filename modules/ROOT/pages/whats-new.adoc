...
Filter visibility in tabs::

Developers can now hide the filters that are not relevant to the content in a Liveboard tab using the `hideirrelevantchipsinliveboardtabs` property in the SDK.
