...
You can now embed Spotter 3 experience, which introduces several new capabilities, agentic analytics, and enhanced user experience. Spotter 3 is Early Access feature and disabled by default on ThoughtSpot embedded instances.
