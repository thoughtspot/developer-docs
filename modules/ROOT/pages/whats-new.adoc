...
If you are using Vercel to build and maintain their embedding application, you can connect your Vercel project to a ThoughtSpot instance, create content, and embed this content in your app.
...
In full application embedding, you can now review user feedback on the natural language search queries in the **Data** page. For more information, see link:https://docs.thoughtspot.com/cloud/latest/sage-coach[Sage Coach, window=_blank].
