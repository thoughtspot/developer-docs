...
[discrete]
==== Liveboard browser cache refresh [earlyAccess eaBackground]#Early Access#
To improve load performance and reduce, you can now enable the Liveboard cache option with a **Refresh** button to allow your users to clear cache and refresh visualization data when required. This is an early access feature.

For SDK event and action IDs, see the xref:api-changelog.adoc#_liveboard_browser_cache_refresh[Liveboard browser cache refresh].
