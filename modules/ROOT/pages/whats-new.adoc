...
If you are embedding the **Home** page of ThoughtSpot application, and you want to retain both the Object Search and Natural Language Search experience for your users, you need to make a few changes to your application experience. For more information, see xref:full-app-customize.adoc#_search_experience[Search experience customization].
...
For more information, see xref:selective-access.adoc[User access].

=== Liveboard width breakpoints
...
For more information, see xref:embed-liveboard.adoc#_redefine_liveboard_breakpoint_widths[Redefine Liveboard breakpoint widths].
