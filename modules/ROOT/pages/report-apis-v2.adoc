...
|`PINNED`
|GUID or name of the *Liveboard* containing the pinned Answer
...
|Use the Liveboard GUID as `metadata_identifier`, not the Answer GUID.
...
Valid range: `600px` to `3840px`. Default: `1588px`.
