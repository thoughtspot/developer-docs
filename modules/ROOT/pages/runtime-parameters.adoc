...
* link:https://docs.thoughtspot.com/software/latest/parameters-use[Using Parameters, window=_blank]
* link:https://docs.thoughtspot.com/software/latest/parameters-create[Creating Parameters, window=_blank]
