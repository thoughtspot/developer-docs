...
[NOTE]
====
Runtime Parameters is not a security feature. To implement data security rules in ThoughtSpot, please use link:rls-rules.adoc[Row Level Security (RLS rules).
====
