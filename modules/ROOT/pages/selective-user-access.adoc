...
You can turn on the selective user access feature by going to *Admin* > *Application settings*> *Administration* > *Selective User Access* and editing the status to *Enabled*.
