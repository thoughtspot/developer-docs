...
. Navigate to image:./images/app_switcher.png[the app switcher menu] > *Data models*.
+
`\https://<your-thoughtspot-instance>/#/data/tables/`

. On the **Data workspace** > **Home** page, click on data object type. For example, if the data source object is a Worksheet, click **Worksheets** and open the Worksheet.
