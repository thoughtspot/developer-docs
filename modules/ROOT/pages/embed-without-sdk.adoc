...
If you have configured ThoughtSpot to use the same SAML provider as your web application login page, you can create a simple html page to seamlessly embed a ThoughtSpot Liveboard or individual visualizations.
...
<body>
    ...
    <div class="iframe-container">
        <iframe 
        src="https://{thoughtspot-server}.thoughtspot.cloud/?embedApp=true&p&{field_name}=Region&op1=EQ&val1={field_value}&orgid={org_id}>#/embed/viz/{liveboard_guid}">
        </iframe>
    </div>
</body>
</html>
