...
=== Chart settings icon
The chart type icon appears in the settings panel in the Answer edit layout. The icon ID is `rd-icon-chart-type-settings`.
...
If the new chart settings experience is not enabled on your instance, use the `rd-icon-chart` ID in your SVG file.
