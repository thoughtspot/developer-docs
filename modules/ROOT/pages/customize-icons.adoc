...
=== Chart settings icon
The chart type icon appears in the settings panel of the Answer edit layout if the xref:https://docs.thoughtspot.com/software/latest/charts-new[new chart settings UI experience, window=_blank] is enabled on your instance. The icon ID is `rd-icon-chart-type-settings`.
...
If the xref:https://docs.thoughtspot.com/software/latest/charts-new[new chart settings UI experience, window=_blank] is not enabled on your instance, use the `rd-icon-chart` ID in your SVG file.
