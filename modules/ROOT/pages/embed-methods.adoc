...
ThoughtSpot Embedded offers a robust API framework with Visual Embed SDK and REST APIs to embed and customize ThoughtSpot components and automate deployments. You can explore these APIs and preview the coding experience in the interactive developer playgrounds.
...
The minimum ThoughtSpot version required for embedding ThoughtSpot components using Visual Embed SDK is 8.4.1-sw release.
