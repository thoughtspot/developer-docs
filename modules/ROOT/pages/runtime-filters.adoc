...
<a href="{{previewPrefix}}/playground/liveboard?runtimeFilters=true" id="preview-in-playground" window="_blank">Try it out in Playground</a>
</div>
++++
--
...
The SDK supports See xref:HostEvent.adoc#_updateruntimefilters[UpdateRuntimeFilters] and xref:embed-events.adoc#_filters_in_embedded_ui[Filters in embedded UI].
