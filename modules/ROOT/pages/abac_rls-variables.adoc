...
If the object ID is not specified in the API request, the variable values are applied to all formulas and rules that use those variables, across all objects in the Org for that user.
