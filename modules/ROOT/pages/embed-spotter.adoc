...
* You have access to the latest version of the Visual Embed SDK or at least v1.33.1. For Spotter  features and customization settings, use the Visual Embed K
