...
[NOTE]
====
The Analyst Studio option is not available in the ThoughtSpot embedded application. For more information, see link:https://docs.thoughtspot.com/cloud/latest/analyst-studio-getting-started[Analyst Studio, window=_blank].
====
|===
