...
:page-pageid: rbac
:page-description: Use the Role-based access control feature for granular access control
...
For more information about Role and Group assignment, see link:https://docs.thoughtspot.com/cloud/latest/rbac[ThoughtSpot Product Documentation, window=_blank].
...
UI: *Can manage roles*  | Allows users to create, edit, and manage Roles via UI or REST API calls.
...
UI: *Can view system activities*  | Allows users to view system activities and monitor health.
...
|Spotter access|API: `CAN_USE_SPOTTER` +
UI: *Can use Spotter* | Allows access to ThoughtSpot Spotter and natural language query and answer generation.
|Spotter administration|API: `CAN_MANAGE_SPOTTER` +
UI: *Can manage Spotter* a| Allows a designated Spotter administrator to manage Spotter's behavior across the organization. This role provides the following capabilities:
...
UI: *Can manage catalog*| Allows users to create, edit, and manage a link:https://docs.thoughtspot.com/cloud/latest/catalog-integration[data connector catalog, window=_blank].
|===
...
=== Procedure to unblock the users
