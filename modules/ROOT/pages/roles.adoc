...
When RBAC is enabled, the ALL group is assigned an *ALL role* that grants three base privileges:

* `AUTHORING` — Allows users to create and edit ThoughtSpot content.
* `DATADOWNLOADING` — Allows users to download data from ThoughtSpot Answers and Liveboards.
