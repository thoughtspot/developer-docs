...
|ThoughtSpot cluster access|API: `ALLOW_NON_EMBED_FULL_APP_ACCESS` +
UI: *Can access non-embedded ThoughtSpot application*  | Allows users to access non-embedded ThoughtSpot pages from their embedded app context.
|===
