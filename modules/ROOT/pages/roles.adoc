...
UI: *Can set up version control* | Allows users to enable version control for a cluster or Org.
...
[NOTE]
====
The Analyst Studio option is not available in the ThoughtSpot embedded application.
====
|===
