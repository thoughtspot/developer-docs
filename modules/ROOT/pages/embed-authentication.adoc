...
image::../../../static/doc-images/images/auth-type-embed.svg[Embed authentication types]

////
++++
<img src="../images/auth-type-embed.svg" alt="Embed authentication types" usemap="#image-map">
