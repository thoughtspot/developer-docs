...
Assigns a Role to a user group.| ThoughtSpot Software [version noBackground]#9.8.0.sw#
|`xref:group-api.adoc##removeRole[**POST** /tspublic/v1/group/removerole] [beta betaBackground]^Beta^`  +
Removes the Role assigned to a group.|ThoughtSpot Software [version noBackground]#9.8.0.sw#
