...
* link:{{navprefix}}/embed-ai-search-analytics[Embed Spotter AI Analytics]
** link:{{navprefix}}/embed-spotter[Embed full Spotter experience]
** link:{{navprefix}}/customize-spotter-embed[Customize Spotter interface]
** link:{{navprefix}}/customize-spotter-chat-experience[Customize chat experience]
** link:{{navprefix}}/customize-spotter-sidebar[Customize sidebar panel]
** link:{{navprefix}}/customize-spotter-sharing[Customize conversation sharing experience]
** link:{{navprefix}}/customize-spotter-analysts[Configure Spotter Analysts]
** link:{{navprefix}}/embed-spotter-agent[Embed Spotter AI without ThoughtSpot UI]
* link:{{navprefix}}/embed-liveboard[Embed live analytics]
...
** link:{{navprefix}}/set-default-page[Set default landing page and navigation]
...
* link:{{navprefix}}/webhooks-overview[Webhooks]
...
*** link:{{navprefix}}/process-conversation-output[Process Spotter agent conversation results]
...
* link:{{navprefix}}/rest-api-sdk-libraries[Overview]
...
* link:{{navprefix}}/tutorials/tutorials-overview[Embedding tutorial]
