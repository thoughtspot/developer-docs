...
* link:{{navprefix}}/tsembed[Embed ThoughtSpot]
...
*** link:{{navprefix}}/action-config[Control actions and menu items]
**** link:{{navprefix}}/actions[Actions reference]

*** Integrate with embedding app
...
**** link:{{navprefix}}/git-configuration.adoc[Configure Git integration]
**** link:{{navprefix}}/git-rest-api-guide.adoc[Git integration REST API guide]
**** link:{{navprefix}}/guid-mapping.adoc[GUID mapping during deploy commits]
*** link:{{navprefix}}/deploy-with-tml-apis.adoc[Deploy with TML APIs]
*** link:{{navprefix}}/thoughtspot-objects[ThoughtSpot objects overview]
*** link:{{navprefix}}/modify-tml[TML modification guide]
