...
** link:https://developers.thoughtspot.com/docs/embed-sdk-changelog[SDK and API changelog, window=_blank]
...
** link:{{navprefix}}/troubleshoot-errors[Troubleshoot errors, window=_blank]
