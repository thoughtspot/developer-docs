...
** link:https://developers.thoughtspot.com/docs/embed-sdk-changelog[Visual Embed changelog]
...
**** link:{{navprefix}}/custom-css[CSS variables and overrides]
...
*  link:{{navprefix}}/thoughtspot-objects[Deployment and integration]
...
** link:https://developers.thoughtspot.com/docs/faqs[FAQs]
** link:https://developers.thoughtspot.com/docs/troubleshoot-errors[Troubleshoot errors]
