...
** Embed Natural Language Search and conversation
*** link:{{navprefix}}/embed-spotter[Embed conversation interface ^BETA^]
*** link:{{navprefix}}/tutorials/spotter/integrate-into-chatbot[Integrate conversation interface into a Chatbot ^BETA^]
*** link:{{navprefix}}/embed-nls[Embed Natural Language Search component]
** link:{{navprefix}}/full-embed[Embed full application]
** Embed token-based Search
*** link:{{navprefix}}/search-embed[Embed search data]
