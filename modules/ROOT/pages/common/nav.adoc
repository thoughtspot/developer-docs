...
* link:{{navprefix}}/js-reference-test[Visual Embed SDK Reference]
** link:{{navprefix}}/appEmbed[AppEmbed]
** link:{{navprefix}}/search-bar-embed[Search bar embed]
** link:{{navprefix}}/host-event-ref[Host Events]
