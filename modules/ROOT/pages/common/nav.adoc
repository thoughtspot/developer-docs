...
*** link:{{navprefix}}/tutorials/react-components/lesson-01[01 - Initializing Embed SDK]
...
*** link:{{navprefix}}/tutorials/react-components/lesson-04[04 - ThoughtSpot component pages]
