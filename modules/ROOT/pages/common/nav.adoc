...
**** link:{{navprefix}}/embed-nls[Embed Natural Language Search (legacy)]
...
*** link:{{navprefix}}/embed-ts-mobile-react-native[Embed using React Native mobile SDK]
...
*** link:{{navprefix}}/third-party-tool-script-integration[Integrate third-party tools and scripts]
