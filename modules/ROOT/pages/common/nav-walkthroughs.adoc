...
** link:{{navprefix}}/tutorials/embed-data-driven-app/step-01[Get the base dashboard rendering]
** link:{{navprefix}}/tutorials/embed-data-driven-app/step-02[Make it conversational]
** link:{{navprefix}}/tutorials/embed-data-driven-app/step-03[Style it to match the portal]
** link:{{navprefix}}/tutorials/embed-data-driven-app/step-04[Wire in a custom action]
