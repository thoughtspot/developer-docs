...
Assigns multiple values and scope of each set of variable values in a single API request.
...
The following API endpoints now support pivot tables in .xlsx format with full visual and structural parity:
