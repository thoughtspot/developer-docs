...
show_resolved_parameters property Added
...
Body
application/json content type Modified
png_options property Modified
image_resolution, image_scale, include_header properties Added
tab_identifiers, personalised_view_identifier properties Added
Added
9
