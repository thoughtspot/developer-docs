...
== Version 10.4.0.cl, December 2024
You can now define an additional user state, SUSPENDED, in your API request to the following endpoints:

`POST /api/rest/2.0/users/create`

`POST /api/rest/2.0/users/{user_identifier}/update`

For more information, see xref:api-user-management.adoc[User state management with IAMv2]
