...
variable_values property Added
...
operation, values properties Removed
Removing a resource is always breaking unless it was deprecated before Breaking
POST /api/rest/2.0/template/variables/update-values
Path went from /api/rest/2.0/template/variables/update to /api/rest/2.0/template/variables/update-values (same operationId) Breaking
Body
application/json content type Modified
variable_updates, operation properties Removed
Removing a resource is always breaking unless it was deprecated before Breaking
variable_assignment, variable_value_scope properties Added
POST /api/rest/2.0/template/variables/search
Body
application/json content type Modified
value_scope property Added
Response
200 response Modified
application/json content type Modified
values property Modified
value_list property Added
POST /api/rest/2.0/template/variables/create
Body
application/json content type Modified
sensitive, values properties Removed
Removing a resource is always breaking unless it was deprecated before Breaking
is_sensitive, data_type properties Added
Response
200 response Modified
application/json content type Modified
values property Modified
...
200 response Modified
application/json content type Modified
guid, objId, columnSecurityRules properties Removed
Removing a resource is always breaking unless it was deprecated before Breaking
table_guid, obj_id, column_security_rules properties Added
POST /api/rest/2.0/metadata/tml/export
Body
application/json content type Modified
export_options property Modified
export_with_column_aliases property Added
...
Body
application/json content type Modified
template_properties property Modified
company_privacy_policy_url, company_website_url properties Added
