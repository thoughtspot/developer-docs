...
The `/api/rest/2.0/auth/token/custom` API endpoint now allows you to the define `reset_option` to specify if the attributes assigned to the token should persist or be reset.
