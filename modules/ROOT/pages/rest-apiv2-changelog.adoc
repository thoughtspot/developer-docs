...
* The `liveboard_reponse_version` parameter that allows you to specify the xref:rest-api-v2-metadata-search.adoc#lbResponse[response format for Liveboard objects].
