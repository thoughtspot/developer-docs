...
The following endpoints now return the 204 response code instead of 200. The 204 response code doesn't return a body. This may affect your current implementation. We recommend you update your code to avoid issues.
