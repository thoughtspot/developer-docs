...
* `GET /api/rest/2.0/ai/agent/instructions/get` +ß
...
* The `/api/rest/2.0/webhooks/create` endpoint allows configuring GCS storage destination for webhook delivery. The API endpoint also returns the GCS configuration details in response.
