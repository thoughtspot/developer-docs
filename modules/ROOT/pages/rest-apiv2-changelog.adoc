...
Variables search::
* The variables search API endpoint `/api/rest/2.0/template/variables/search` now includes the `value_scope` parameter to allow users to filter API response by variable values.
