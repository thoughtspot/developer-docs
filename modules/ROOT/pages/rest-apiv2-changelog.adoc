...
Gets a list of Collections from the existing Collections
...
Assigns multiple values and scope of each set of variable values in a single AI request.
...
Your existing implementation with the legacy API endpoints will continue to work until further notice. However, these endpoints will be removed from ThoughtSpot in a future release. Hence, we recommend you to update your workflows to use the API endpoints at your earliest convenience.
...
>>>>>>> 3b533974 (26.4.0.cl doc updates)
