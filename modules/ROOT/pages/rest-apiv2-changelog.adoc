...
This release introduces the following new endpoints for connection configuration:

* `POST /api/rest/2.0/connection-configurations/create` +
Creates a new configuration for the connection.
* `POST /api/rest/2.0/connection-configurations/search` +
Searches for a connection configuration.
* `POST /api/rest/2.0/connection-configurations/{configuration_identifier}/update` +
Updates the properties of a connection configuration.
* `POST /api/rest/2.0/connection-configurations/delete` +
Deletes the configuration from the connection.
