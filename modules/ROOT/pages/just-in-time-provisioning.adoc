...
The steps to JIT provisioning are conceptually:
 ...
 .  Does user exist in this Org?
 .. If user does not exist, create user or add to Org
 .. If user exists, update to current assignments (including group membership)
 . Update any variable values via custom token request
