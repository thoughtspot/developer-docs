...
[NOTE]
====
The following settings on the **Security Settings** page are locked for ThoughtSpot users.
...
Users will require an embedding license to access these features.
====
...
You can add external URLs as trusted domains from which you want to import images, fonts, and stylesheets.
