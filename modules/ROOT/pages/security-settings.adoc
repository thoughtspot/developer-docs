...
Cluster administrators can configure security settings globally for all Orgs. By default, ThoughtSpot logs its user into `Primary Org`. To configure settings for all Orgs, navigate to *Develop* > *All Orgs* > *Security Settings*.
