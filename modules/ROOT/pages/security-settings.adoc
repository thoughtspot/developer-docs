...
[NOTE]
====
Safari blocks all third-party cookies and doesn't support partitioned cookies. ThoughtSpot recommends using cookieless authentication if your embedding implementation uses Safari.
====
