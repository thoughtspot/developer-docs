= Migrating JWT ABAC with filter_rules to ABAC via RLS
:toc: true
:toclevels: 2

:page-title: JWT ABAC with filter_rules to ABAC via RLS
...
To migrate from JWT ABAC with filter_rules to ABAC via RLS, complete the following checks:
