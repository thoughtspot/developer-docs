...
Once the Theme Builder has been enabled for your ThoughtSpot instance, you can access it from the *Develop* > *Customisations* > *Theme Builder*.
Alternatively, you can click *Live Playgrounds* > *Theme Builder* on this documentation site, or go to link:https://developers.thoughtspot.com/docs/theme-builder[https://developers.thoughtspot.com/docs/theme-builder, window=_blank].
