...
Theme builder also lets you iterate on existing themes by importing a JSON. You can use an existing style in Theme builder, and add to it by importing the theme in JSON. To upload a set of CSS variables in JSON format:
