= GUID mapping and deploy commits
:toc: true
:toclevels: 2
...
The xref:git-rest-api-guide.adoc#deploy-commits[deploy commits API endpoint] automatically generates a GUID mapping file in the  when deploying commits and saves this file in the `config` Git branch. 
