...
link:https://docs.thoughtspot.com/software/latest/connections[Connections, window=_blank] contain the majority of details that vary between data environments, other than the `db` and `schema` properties within the table objects.
