...
|`nl_instructions_info` a|Instructions in natural language format.
...
* For information about the MCP tools, see xref:mcp-integration.adoc[MCP server integration].
