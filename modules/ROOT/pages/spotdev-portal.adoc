...
+
++++
<a href="{{previewPrefix}}/playground/search" id="preview-in-playground" window="_blank">Visit the Playground</a>
++++
...
+
++++
<a href="{{previewPrefix}}/api/rest/playgroundV1" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
+
++++
<a href="{{previewPrefix}}/api/rest/playgroundV2" id="preview-in-playground" window="_blank">Try it out</a>
++++
