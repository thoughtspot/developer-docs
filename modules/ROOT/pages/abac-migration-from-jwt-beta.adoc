...
* xref:abac-migration-from-jwt-beta.adoc#_review_your_jwt_abac_beta_implementation[Review your JWT ABAC Beta implementation]
* xref:abac-migration-from-jwt-beta.adoc#_set_up_abac_via_rls[Set up ABAC via RLS]
* xref:abac-migration-from-jwt-beta.adoc#_review_the_configuration[Review the configuration]
* xref:abac-migration-from-jwt-beta.adoc#_test_the_migration[Test the migration]
...
* link:https://docs.thoughtspot.com/software/latest/rls-variables-reference#_defining_a_row_level_security_rule_with_variables[Create RLS rules on tables and reference these variables in the rules, window=_blank].
...
* ThoughtSpot administrators are exempt from RLS by default. For more information, see link:https://docs.thoughtspot.com/software/latest/security-rls-concept#exempt-rls[How rule-based RLS works, window=_blank].
====
