...
+
Search Assist uses the predefined queries and answers from the Worksheet. Users with edit permissions to a Worksheet can define Search Assist queries and answers to assist users with search.
...
For more information about the new data panel, see link:https://docs.thoughtspot.com/cloud/latest/search-start[ThoughtSpot product documentation].
