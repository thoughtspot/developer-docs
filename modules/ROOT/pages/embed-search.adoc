...
+
++++
<a href="{{previewPrefix}}/playground/search?collapseDataSources=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
+
++++
<a href="{{previewPrefix}}/playground/search?modifyActions=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
+
++++
<a href="{{previewPrefix}}/playground/search?hideDataSources=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
+
++++
<a href="{{previewPrefix}}/playground/search" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
+
++++
<a href="{{previewPrefix}}/playground/search?hideResults=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
...
++++
<a href="{{previewPrefix}}/playground/search/searchOptions=true" id="preview-in-playground" window="_blank">Try it out</a>
++++
////
