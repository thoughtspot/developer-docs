...
=== Data panel experience in the embedded Search page (optional)
...
For more information about the new data panel experience, see link:https://docs.thoughtspot.com/software/latest/search-start[ThoughtSpot product documentation, window=_blank].
