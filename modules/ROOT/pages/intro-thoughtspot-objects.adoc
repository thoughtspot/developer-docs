...
3. Create *Worksheets* (analytic data models) based on tables. You can also create link:https://docs.thoughtspot.com/software/latest/models[Models, window=_blank] and add tables.
...
ThoughtSport also supports programmatic deployment of data models via  link:https://docs.thoughtspot.com/software/latest/tml[ThoughtSpot Modeling Language (TML), window=_blank] and table import from link:https://docs.thoughtspot.com/software/latest/dbt-integration#integrate[dbt, window=_blank].
...
Search data serves the role of report builder or widget designer, while *Liveboards* serve the role of dashboards in other tools. A single search can be saved as an link:https://docs.thoughtspot.com/software/latest/answers[Answer, window=_blank] object, or the search result can be pinned to a Liveboard.
...
1. Use the *link:https://docs.thoughtspot.com/software/latest/search-data[Search data, window=_blank]* functionality to build visualizations from data sources such as *worksheets* or *views*.
...
ThoughtSpot's link:https://docs.thoughtspot.com/software/latest/data-security[access control model, window=_blank] works by an `author` or `administrator` sharing objects to link:https://docs.thoughtspot.com/software/latest/groups-privileges[ThoughtSpot groups, window=_blank] or other individual users:
