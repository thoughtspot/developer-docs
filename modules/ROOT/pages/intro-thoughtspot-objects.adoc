...
3. Create link:https://docs.thoughtspot.com/software/latest/models[*Models*, window=_blank] (analytic data models) based on tables.
4. Create link:https://docs.thoughtspot.com/software/latest/views[ThoughtSpot Views, window=_blank] or link:https://docs.thoughtspot.com/software/latest/sql-views[SQL Views, window=_blank] as necessary.

ThoughtSpot also supports programmatic deployment of data models via link:https://docs.thoughtspot.com/software/latest/tml[ThoughtSpot Modeling Language (TML), window=_blank] and table import from link:https://docs.thoughtspot.com/software/latest/dbt-integration#integrate[dbt, window=_blank].
...
Search data serves the role of report builder or widget designer, while *Liveboards* serve the role of dashboards in other tools. A single search can be saved as a link:https://docs.thoughtspot.com/software/latest/answers[*Answer*, window=_blank] object, or the search result can be pinned to a Liveboard.

A link:https://docs.thoughtspot.com/software/latest/liveboard[Liveboard, window=_blank] is a collection of many visualizations presented in a defined layout. You do not create the visualizations on a Liveboard directly; they are created from search data results and then pinned to a Liveboard. You can create a new Liveboard from the *Liveboards* page and then add a visualization from the search data result, or you can create a new Liveboard when pinning an Answer retrieved from search data.

=== Content creation workflow

To create content:

1. Use the link:https://docs.thoughtspot.com/software/latest/search-data[Search data, window=_blank] functionality to build visualizations from data sources such as *Models* or *Views*.
...
=== Tags
link:https://docs.thoughtspot.com/software/latest/tags[Tags, window=_blank] allow you to organize your objects and find them easily.
...
ThoughtSpot's link:https://docs.thoughtspot.com/software/latest/data-security[access control model, window=_blank] works by having an `author` or `administrator` share objects with link:https://docs.thoughtspot.com/software/latest/groups-privileges[ThoughtSpot groups, window=_blank] or individual users:
...
* link:https://docs.thoughtspot.com/latest[ThoughtSpot product documentation, window=_blank]
