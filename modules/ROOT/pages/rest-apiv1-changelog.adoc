...
If the Orgs feature is enabled and Orgs are created on your cluster, the cluster administrators can use the `/tspublic/v1/session/orgs` to xref:session-api.adoc#orgSwitch[Switch between Orgs].
+
