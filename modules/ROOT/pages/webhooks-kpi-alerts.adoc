...
== Configuring a webhook for KPI alerts
To configure a webhook and send KPI monitor alerts to an external application or URL, xref:webhooks-ux.adoc#webhook-configuration-and-management-legacy-experience[create a webhook in ThoughtSpot UI].
