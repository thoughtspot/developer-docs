...
For more information about locale customization for ThoughtSpot Embedded application users, see the xref:locale-setting.adoc[Locale customization, window=_blank].
...
For more information, see link:https://docs.thoughtspot.com/software/latest/liveboard-filters#_apply_filters_to_specific_visualizations_or_tabs[Apply filters to specific visualizations or tabs].
...
+
This feature is disabled by default and can be enabled by administrators. For more information, see link:https://docs.thoughtspot.com/software/latest/personalized-liveboard-views[ThoughtSpot Product Documentation].

Embedding in note tiles::
You can now embed interactive content such as videos in an iFrame on a Liveboard Note tile. For more information, see link:https://docs.thoughtspot.com/software/latest/liveboard-notes#embed[ThoughtSpot Product Documentation].
...
+
For more information about the new Liveboard experience, see link:https://docs.thoughtspot.com/software/latest/liveboard-experience-new[New Liveboard experience, window=_blank].
