...
. To access the ThoughtSpot Developer portal, click *Develop*
. Under *Customizations*, click *Styles*.
. Click *Edit* under the *Chart Color Palettes* section.
. To add a new color scheme, click *+ Add*.
. To modify an existing color, click the existing color.
+
The color picker displays.
. Choose a new color or enter the HEX color code.
. Click *Save*.

[#footer-text]
== Add footer text
You can add footer text with hyperlinks to the ThoughtSpot application.

To add footer text:

. To access the ThoughtSpot Developer portal, click *Develop*
. Under *Customizations*, click *Styles*.
. Add your text in the *Footer Text* box.
. Click *Save changes*.

[NOTE]
====
The footer text is displayed at the bottom of the ThoughtSpot application page. The footer text is not displayed in embedded applications.
====
...
. To access the ThoughtSpot Developer portal, click *Develop*
. Under *Customizations*, click *Styles*.
. Enter your text in the *Page Title* box.
. Click *Save changes*.
