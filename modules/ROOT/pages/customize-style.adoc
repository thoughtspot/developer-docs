...
[IMPORTANT]
======
The wide logo dimensions changed in ThoughtSpot Cloud 26.8.0.cl. If you previously uploaded a logo sized at 330px by 100px, re-upload your logo at 250px by 50px to ensure it displays correctly on the login screen without distortion.
======
