...
You can rebrand the ThoughtSpot interface elements such as the application logo, navigation panel color, footer text, and the color scheme of visualizations.
