...
To add the Spotter MCP Server to Visual Studio Code, you can use the Extensions view, the `MCP: Add Server` command via command palette, or directly edit the `mcp.json` file in your workspace configuration.
...
This configuration will automatically enable SpotterCode in Claude AI chat and Claude Code for users of the Claude account.
